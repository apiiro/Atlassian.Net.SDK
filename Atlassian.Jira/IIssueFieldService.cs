...
namespace Atlassian.Jira
{
    ...
    public interface IIssueFieldService
    {
        ...
        /// <param name="token">Cancellation token for this operation.</param>
        Task<IReadOnlyDictionary<string, IReadOnlyCollection<RemoteField>>> GetCreateFieldsSchemaForProjectAndIssueTypeAsync(string projectKey, string issueTypeId = null,
